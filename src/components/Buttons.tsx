...
export function AddHeroButton({ handleOpenNewHero }: IProps): ReactElement {
    return (
        <button
            ...
            className="bg-emerald-500 hover:bg-emerald-400 text-white font-semibold w-full rounded-md py-2 px-4 sm:w-auto"
        >
...
export function RandomizeButton(): ReactElement {
    return (
        <button className="bg-purple-500 hover:bg-purple-400 text-white font-semibold w-full rounded-md py-2 px-4 sm:w-auto">
            <div className="flex items-center justify-center sm:justify-left">
...
export function DeleteHeroButton(): ReactElement {
    return (
        <button className="hover:text-red-400 text-red-600 font-semibold w-auto rounded-md py-2 px-4">
